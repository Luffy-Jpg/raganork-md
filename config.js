...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~02d88ee9a3e788f7ab1e7328c689fab1:7358457a336d6e515742493d').trim() || '',
    ...
    RBG_KEY: process.env.RBG_KEY || 'iRyB8NszW5zR9v7xcPwavqeU',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "RDJ-Ai",
    BOT_NAME: process.env.BOT_NAME || 'RDJ-Ai',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'RDJ-Ai' : process.env.AUDIO_DATA,
    ...
    SUDO: process.env.SUDO || "917090462940",
