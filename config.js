...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'Jeff Pvt Bot',
    ...
    STICKER_DATA: process.env.STICKER_DATA || "Jeff💗",
    BOT_NAME: process.env.BOT_NAME || 'Jeff Pvt Bot',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'Jeff Musics;' : process.env.AUDIO_DATA,
